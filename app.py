...
DATA_BASE_PASSWORD = os.environ.get("EMAIL_HOST_PASSWORD")

app.config['SQLALCHEMY_DATABASE_URI']=f"postgresql://postgres:{DATA_BASE_PASSWORD}@localhost:5432/db_fyyur"
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False
